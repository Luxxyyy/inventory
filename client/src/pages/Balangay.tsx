function Balangay() {
    ...
    return(
        <div>
            ...
            <div className="mb-3" id="input-box">
                <label htmlFor="formGroupExampleInput2" className="form-label">Longitude</label>
                <input type="text" className="form-control" id="formGroupExampleInput2" placeholder="Enter Longitude"></input>
            </div>     
            <div className="mb-3" id="input-box">
                <label htmlFor="formGroupExampleInput2" className="form-label">Latitude</label>
                <input type="text" className="form-control" id="formGroupExampleInput2" placeholder="Enter Latitude"></input>
            </div>         
